package br.ufsm.csi.seguranca.pila.dao;
...
public class HibernateDAO {
    ...
    public User findUsuario(String login, String senha) throws NoSuchAlgorithmException, UnsupportedEncodingException {
    ...
    public User findUsuarioHQL(String login, String senha) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        MessageDigest md = MessageDigest.getInstance("SHA-256");
        byte[] senhaSHA = md.digest(senha.getBytes("ISO-8859-1"));
        Query q = sessionFactory.getCurrentSession().createQuery(
                "select u from br.ufsm.csi.seguranca.pila.model.User as u " +
