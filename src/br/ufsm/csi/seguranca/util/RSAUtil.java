...
public class RSAUtil {
    ...
    private final static String URL = "C:\\Users\\ander\\Desktop\\hibernate\\hibernate-csi-master\\";
    ...
    */
    ...
    public static PrivateKey getPrivateKey(String filename) throws Exception {
        ...
        byte[] keyBytes = Files.readAllBytes(Paths.get(URL + filename));
    ...
    public static PublicKey getMasterPublicKey() throws Exception {
        synchronized (RSAUtil.class) {
            if (MASTER_PUB_KEY == null) {
                byte[] keyBytes = Files.readAllBytes(Paths.get(URL + "Master_public_key.der"));
                X509EncodedKeySpec spec =
                        new X509EncodedKeySpec(keyBytes);
                KeyFactory kf = KeyFactory.getInstance("RSA");
